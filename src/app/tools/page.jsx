...
// SearchParams ke liye alag component banate hain
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-400 max-w-2xl mx-auto">
            Explore our complete collection of professional business tools
          </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto mb-8">
          <div className="relative">
            <input
              ...
              className="w-full px-6 py-4 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl focus:outline-none focus:border-purple-500 transition"
            />
            ...
            return (
              ...
              >
                <div className="group relative p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 
                  ...
                  <h3 className="relative text-xl font-bold mb-2 group-hover:text-purple-400 transition-colors">
                    {tool.title}
                  </h3>
